...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ValueT2D < 18.5)
            result_text.setText(getString(R.string.Result_TEXT)+"不良 太輕");
        else if (ValueT2D < 24)
            result_text.setText(getString(R.string.Result_TEXT)+"正常 健康");
         else
            result_text.setText(getString(R.string.Result_TEXT)+"不良 過重");
